...
Opened 2026-09-03. Snapshot date for market tape on this pass is the **2026-09-21 close**. Filing rows remain the last company prints.
...
| Why | The danger level is 3 because cheap-tier token prices and neocloud H100 rental have already fallen, while NVIDIA's $105 billion residual-value cap is still on the books and the hub equity mark is intact. Monday's close left NVIDIA at $227.38, about 3.9 percent below the May high, and that bounce does not change the conversion-rate race. | Mixed |
...
| 6 | One neocloud credit or equity stress print | **CoreWeave (CRWV)**. Equity **$85.43** on 2026-09-21, about **−44%** from the 52-week high of $153.20. Debt about **$35B** at 2026-06-30 vs ~$21B YE2025. Priced $3.7B of 2.875% converts due 2033 on 18 September. Financing **still closed**. No missed-payment print found this pass. Monday's close is an equity mark, not a credit event. | Measured (equity, debt stock, priced issue) / Hypothesis-adjacent (CDS and earlier new-issue levels from secondary reporting) | Market tape 2026-09-21 close. Company convert pricing 2026-09-18. |
...
| 8 | SOX vs SPX, 3-month | SOX closed **12,433.17** on 2026-09-21 versus ATH **14,655.29** (~2026-06-22), about **−15.2%** from the high. Semis remain de-rated versus the June high even after Monday's bounce. | Measured | FRED / Nasdaq SOX 2026-09-21. |
...
| Object | Print | Tag |
| --- | --- | --- |
| NVDA last / ATH | Close **$227.38** on 2026-09-21 (+2.30%). 52-week / cycle high **$236.54** on 2026-05-14. About **3.9%** below that high. | Measured |
| SOX | **12,433.17** on 2026-09-21. | Measured |
| CRWV last | Close **$85.43** on 2026-09-21 after pricing $3.7B 2.875% converts due 2033 on 18 September. | Measured |
| Cheap-tier token cut | OpenAI 2026-07-30: GPT-5.6 Luna −80% to $0.20/$1.20 per 1M; Terra −20% to $2.00/$12.00. Still listed on the official API page on 2026-09-22. | Measured (provider card) |
| GPU rental | CCIR 2026-09-20 07:30 ET guaranteed on-demand: H100 hyperscaler $11.25 / neocloud $3.37 / marketplace $3.19. | Measured as a published series |
...
H4 fails as regime change. July completed a loud free-cash-flow scare at the spenders, a SOX drawdown from the June high, and some Path-4 deconcentration. It did not produce a capex cut, a supplier order break, or an NVIDIA earnings break. NVIDIA's August print still showed triple-digit data-center growth and a higher third-quarter guide. Later tape recovered NVIDIA to about 3.9 percent off the May all-time high.
...
H5 is open and live on the cheap tier. The 30 July 2026 Luna cut and the 20 September 2026 neocloud rental stack are the price side of the race. The 17 August 2026 $105 billion NVIDIA cap is the paper side. First-party confirmation of OpenAI, Anthropic, Google, and xAI cards on this pass raises source quality and does not add a new cut. Hub marks have not broken. The danger level is 3, not 4 or 5.
...
- **2026-09-22 America/New_York (nightly).** No new hyperscaler 8-K or 10-Q printed, and no capex guide was cut. Official OpenAI, Anthropic, Google, and xAI rate cards were confirmed first-party and showed no new list-price cut. xAI now lists Grok 4.7 at the same $2 / $6 rates. CCIR rental is the 20 September 07:30 Eastern print. NVIDIA closed at $227.38 on 21 September 2026, about 3.9 percent off the May high of $236.54. SOX closed at 12,433.17. CoreWeave closed at $85.43. H4 remains a fail as regime change. H5 remains open and live on the cheap tier. The danger level held at 3, Stressed.
