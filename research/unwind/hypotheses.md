...
Claim: S&P and Nasdaq returns remain a concentrated bet on a small AI-linked set. An unwind shows up first as deconcentration and factor rotation, not as a 2000-style wipeout of the whole tape.

Kill: Mag7 / top-10 S&P weight stabilizes or rises from here while equal-weight and the S&P 493 keep lagging for two more quarters.

Status: **open, weakly live**.
...
What would move H1 to live-confirmed: two more quarters of falling Mag7 weight *and* equal-weight leadership that survives an NVDA new high. What would kill it: Mag7 weight back through the June high while RSP lags.

## H2 — capex vs incremental cash flow

Claim: 2026 hyperscaler capex does not generate incremental AI/cloud cash flow fast enough to keep FCF from staying compressed. The cycle turns when managements cut or stretch capex, not when commentators call a bubble.

Kill: combined FCF of AMZN/MSFT/GOOGL/META recovers while 2027 capex guidance stays at or above the 2026 run-rate, and cloud/AI revenue growth does not decelerate.

Status: **open, live on cash, not on demand**.

Measured (see `capex-cash.md`):

- Four-name calendar Q2 cash PPE / OCF ≈ 0.95. AMZN 1.17, GOOGL 1.15, META 0.94, MSFT 0.65. ORCL FY26 1.74.
- AMZN TTM FCF -$7.6B. Guide raised to ~$220B. AWS Q2 +37% to $42.2B.
- GOOGL Q2 FCF -$5.9B. Guide raised to $195-205B. Cloud backlog $514B.
...
Claim: the fragile object is the funding stack. Equity is the last print.

Kill: hyperscaler and neocloud credit spreads and CDS stay contained while circular commitments roll at similar size and cost through mid-2027.

Status: **open**. Architecture is Measured. A hub credit event is not.

Measured (see `circular-finance.md` and dashboard row 6):

- Do not add headline LOIs into one stock. The $100B NVDA-OpenAI LOI of Sep 2025 is not the live instrument. Live funded NVDA equity in OpenAI is $30B inside the Feb 2026 round.
...
Claim: July-August 2026 was the start of a regime change, not a violent reset inside an intact boom.

Kill from the plan: by year-end 2026, AI-infra median stocks reclaim June highs, NVDA makes a new ATH on rising data-center growth, and capex guidance is revised *up* again without another FCF scare.

Status: **fail as regime change**. Narrower claim — spenders are now priced separately from chip shipments — is live and is not the same thing.
