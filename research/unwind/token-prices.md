...
As-of: 2026-09-22. Process note, not a book.
...
|---|---|---:|---:|---|---|---|
| GPT-6 Astra | OpenAI | 10.00 | 50.00 | 2026-09-22 official card | Measured | developers.openai.com / openai.com/api/pricing |
| GPT-5.6 Sol | OpenAI | 4.00 short-context promo (long-context 8.00); company language calls this promotional through at least 2026-11-21 | 20.00 short (30.00 long) | 2026-09-22 | Measured | official pricing page |
| GPT-5.6 Terra | OpenAI | 2.00 | 12.00 | 2026-07-30 cut, still listed 2026-09-22 | Measured | OpenAI 2026-07-30 announcement; official pricing page |
| GPT-5.6 Luna | OpenAI | 0.20 | 1.20 | 2026-07-30 cut (−80% from 1.00 / 6.00), still listed 2026-09-22 | Measured | OpenAI 2026-07-30; official pricing page |
| Claude Opus 5 | Anthropic | 5.00 | 25.00 | 2026-09-22 last confirmed official card | Measured | platform.claude.com/docs |
| Claude Sonnet 5 | Anthropic | 2.00 | 10.00 | 2026-09-22 last confirmed official card | Measured | platform.claude.com/docs |
| Claude Haiku 4.5 | Anthropic | 1.00 | 5.00 | 2026-09-22 last confirmed official card | Measured | platform.claude.com/docs |
| Claude Fable 5.1 | Anthropic | 10.00 | 50.00 | 2026-09-22 last confirmed official card; cache hits $0.25 / 1M | Measured | platform.claude.com/docs |
| Gemini 3.1 Pro | Google | 2.00 (≤200k tokens); 4.00 above 200k | 12.00 (≤200k); 18.00 above 200k | 2026-09-22 last confirmed official page | Measured | ai.google.dev/gemini-api/docs/pricing |
| Gemini 3.8 Flash | Google | 0.75 intro through 2026-12-31; 1.50 starting 2027-01-01 | 3.75 intro through 2026-12-31; 7.50 starting 2027-01-01 | 2026-09-22 last confirmed official page | Measured | ai.google.dev/gemini-api/docs/pricing |
| Grok 4.7 | xAI | 2.00 | 6.00 | 2026-09-22 official model page (same list as prior Grok 4.6 card) | Measured | docs.x.ai / x.ai/docs model pricing |
...
xAI’s official page now names Grok 4.7 at $2.00 / $6.00. That is a model-name refresh at an unchanged conversion rate, not a cut.
...
## GPU rental — 2026-09-20 series, read 2026-09-22

CCIR guaranteed on-demand, US & EU, USD/GPU-hr, as of 2026-09-20 07:30 ET. Secondary series. Tag: **Measured as a published series, not as a company filing.** No newer daily CCIR stamp was public at midnight Eastern on 2026-09-22.

| Silicon | Hyperscaler | Neocloud | Marketplace |
|---|---:|---:|---:|
| B300 | — | 7.67 | 7.42 |
| B200 | 14.24 | 6.69 | 6.79 |
| H200 | 10.30 | 4.29 | 4.52 |
...
- Hyperscaler stickers staying high, or holding at $11.25 on H100, does not rescue a neocloud that financed at the low print.

Do not treat marketplace $3.19 H100 as CoreWeave’s realized yield. Realized yield needs utilization and mix. That print is not in this file.

Neocloud H100 guaranteed printed $3.37 on the 20 September series, unchanged from the 19 September cell. Marketplace H100 printed $3.19, a one-cent tick from $3.20. Those are holds and ticks inside the same cheap band, not a regime change in rental.
...
- H5: live on the cheap tier. Not proven as a bind on hub paper. Missing: a filing that restates residual value, or a rim payment that does not clear. First-party confirmation of the July cards on 2026-09-22 does not add a new cut. Monday’s hub mark is a bounce and is still not a restatement.
