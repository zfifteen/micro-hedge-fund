...
| Prompt revised | 2026-09-05 00:25 ET — newsletter letter plus Proton email |
...
| Email | One message per calendar date to `dominickdomenico@pm.me` |
...
5. Search Gmail for subject `MHF Unwind Letter YYYY-MM-DD`. If that subject already exists today, do not send a second copy. If it does not exist, send exactly one email to `dominickdomenico@pm.me` whose body is the letter.
